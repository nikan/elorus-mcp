...
const lineItemSchema = z.object({
  ...
  unit_value: z
    ...
    .optional()
    .describe(
      "Unit price before tax (use when calculator_mode is 'initial'), e.g. '100.00'"
    ),
  unit_total: z
    .string()
    .optional()
    .describe(
      "Unit price after tax (use when calculator_mode is 'total'), e.g. '124.00'"
    ),
  taxes: z
    .array(z.string())
    .optional()
    .describe("Array of tax IDs to apply (obtain IDs via list_taxes tool)"),
  discount: z
    .string()
    .optional()
    ...
    "create_invoice",
    {
      ...
      inputSchema: {
        ...
        calculator_mode: z
          ...
          .default("initial")
          .describe(
            "'initial' means unit prices are before tax; 'total' means unit prices include tax"
          ),
        currency_code: z
          .string()
          .length(3)
